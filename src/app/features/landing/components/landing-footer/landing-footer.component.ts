          ...
          <div class="footer-grid">
            ...
            <div class="footer-brand">
              <a routerLink="/" class="footer-logo">
                <img [src]="brand.logo" [alt]="brand.name" *ngIf="brand.logo" class="logo-image">
            ...
            <div class="footer-links">
              ...
              <ul class="link-list">
                @for (link of navigation.links; track link.label) {
                  <li>
                    <a [routerLink]="link.path" [fragment]="link.fragment">{{ link.label }}</a>
                  </li>
                }
              </ul>
            </div>
            ...
            <div class="footer-links">
              ...
              <ul class="link-list">
                @for (service of services.items; track service.id) {
                  <li>
...
export class LandingFooterComponent {
  ...
  footer = this.configService.getFooter();
}
